...
/home/mallubeast/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /home/mallubeast/.config/opencode/context/{category}
...
```bash
cat > /home/mallubeast/.config/opencode/context/{category}/navigation.md << 'EOF'
